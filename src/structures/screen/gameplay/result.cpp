...
//
//		this->score = std::make_shared<HorizontalNumber<float>>(*r_score.score);
...
//
//		this->accuracy = std::make_shared<HorizontalNumber<float>>(*r_score.accuracy);
...
//
//		this->combo = std::make_shared<HorizontalNumber<unsigned long>>(*r_score.combo);
...
//			Engine::Render::OriginType::Centre);
...
//			skin.find(Format::Skin::Image::HitObject::hit.at(Core::Type::Game::Gameplay::NoteScore::Perfect)),
//			ORIGIN, get_perfect_image_pos());
//		good_image = std::make_shared<Object>(
//			skin.find(Format::Skin::Image::HitObject::hit.at(Core::Type::Game::Gameplay::NoteScore::Good)),
//			ORIGIN, get_good_image_pos());
//		bad_image = std::make_shared<Object>(
//			skin.find(Format::Skin::Image::HitObject::hit.at(Core::Type::Game::Gameplay::NoteScore::Bad)),
//			ORIGIN, get_bad_image_pos());
//		miss_image = std::make_shared<Object>(
//			skin.find(Format::Skin::Image::HitObject::hit.at(Core::Type::Game::Gameplay::NoteScore::Miss)),
