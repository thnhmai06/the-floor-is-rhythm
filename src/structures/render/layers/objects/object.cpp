...
//! Structures::Render::RenderConfig
using Structures::Render::RenderConfig;
// ::RenderOriginPoint
...
//! Structures::Render::RenderObjects
using namespace Structures::Render::RenderObjects;
// ::RenderObject
SDL_FRect RenderObject::get_sdl_src_rect() const
{
...
void RenderObject::set_origin_pos(const RenderConfig::RenderOriginPoint& custom_origin)
{
